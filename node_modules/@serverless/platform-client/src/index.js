...
class ServerlessSDK {
  ...
  constructor(config = {}) {
    ...
    this.desktop = {
       ...
       *
       * @param {string} orgUid The UID of the Serverless Organization to create the Desktop State in.
       * @param {string} appUid The UID of the Serverless Application to create the Desktop State in.
       * @param {string} serviceName The name of the Serverless Service to create the Desktop State in.
       * @param {string} stageName The name of the Serverless Service Stage to create the Desktop State in.
       * @param {string} stateKey The key or name of the Desktop State to save for this Serverless Service Stage.
       * @param {string} state The state object of arbitrary data you would like to save for this Serverless Service Stage.
       * @returns {Promise<object>}
       */
      saveStageState: (orgUid, appUid, serviceName, stageName, stateKey, state) =>
        desktop.saveStageState(this, orgUid, appUid, serviceName, stageName, stateKey, state),
      /**
       * Get Desktop State for a Service Stage via its key.
       *
       * @param {string} orgUid The UID of the Serverless Organization to get the Desktop State in.
       * @param {string} appUid The UID of the Serverless Application to get the Desktop State in.
       * @param {string} serviceName The name of the Serverless Service to get the Desktop State in.
       * @param {string} stageName The name of the Serverless Service Stage to get the Desktop State in.
       * @param {string} stateKey The key or name of the Desktop State to get for this Serverless Service Stage.
       * @returns {Promise<object>}
       */
      getStageState: (orgUid, appUid, serviceName, stageName, stateKey) =>
        desktop.getStageState(this, orgUid, appUid, serviceName, stageName, stateKey),
      /**
       * Delete Desktop state for a Service Stage by specifying its key.
       *
       * @param {string} orgUid The UID of the Serverless Organization to delete the Desktop State in.
       * @param {string} appUid The UID of the Serverless Application to delete the Desktop State in.
       * @param {string} serviceName The name of the Serverless Service to delete the Desktop State in.
       * @param {string} stageName The name of the Serverless Service Stage to delete the Desktop State in.
       * @param {string} stateKey The key or name of the Desktop State to delete for this Serverless Service Stage.
       * @returns {Promise<object>}
       */
      removeStageState: (orgUid, appUid, serviceName, stageName, stateKey) =>
        desktop.removeStageState(this, orgUid, appUid, serviceName, stageName, stateKey),
    };
  }
