...
- [ServerlessSDK](#ServerlessSDK)
  ...
  - [.desktop](#ServerlessSDK+desktop) : <code>object</code>
    - [.saveStageState(orgUid, appUid, serviceName, stageName, stateKey, state)](#ServerlessSDK+desktop.saveStageState) ⇒ <code>Promise.&lt;object&gt;</code>
    - [.getStageState(orgUid, appUid, serviceName, stageName, stateKey)](#ServerlessSDK+desktop.getStageState) ⇒ <code>Promise.&lt;object&gt;</code>
    - [.removeStageState(orgUid, appUid, serviceName, stageName, stateKey)](#ServerlessSDK+desktop.removeStageState) ⇒ <code>Promise.&lt;object&gt;</code>
...
<a name="ServerlessSDK+desktop.saveStageState"></a>

#### desktop.saveStageState(orgUid, appUid, serviceName, stageName, stateKey, state) ⇒ <code>Promise.&lt;object&gt;</code>

Create or update Desktop state for a Service Stage by specifying a key and some data.

**Kind**: static method of [<code>desktop</code>](#ServerlessSDK+desktop)

| Param       | Type                | Description                                                                                  |
| ----------- | ------------------- | -------------------------------------------------------------------------------------------- |
| orgUid      | <code>string</code> | The UID of the Serverless Organization to create the Desktop State in.                       |
| appUid      | <code>string</code> | The UID of the Serverless Application to create the Desktop State in.                        |
| serviceName | <code>string</code> | The name of the Serverless Service to create the Desktop State in.                           |
| stageName   | <code>string</code> | The name of the Serverless Service Stage to create the Desktop State in.                     |
| stateKey    | <code>string</code> | The key or name of the Desktop State to save for this Serverless Service Stage.              |
| state       | <code>string</code> | The state object of arbitrary data you would like to save for this Serverless Service Stage. |

<a name="ServerlessSDK+desktop.getStageState"></a>

#### desktop.getStageState(orgUid, appUid, serviceName, stageName, stateKey) ⇒ <code>Promise.&lt;object&gt;</code>

Get Desktop State for a Service Stage via its key.

**Kind**: static method of [<code>desktop</code>](#ServerlessSDK+desktop)

| Param       | Type                | Description                                                                    |
| ----------- | ------------------- | ------------------------------------------------------------------------------ |
| orgUid      | <code>string</code> | The UID of the Serverless Organization to get the Desktop State in.            |
| appUid      | <code>string</code> | The UID of the Serverless Application to get the Desktop State in.             |
| serviceName | <code>string</code> | The name of the Serverless Service to get the Desktop State in.                |
| stageName   | <code>string</code> | The name of the Serverless Service Stage to get the Desktop State in.          |
| stateKey    | <code>string</code> | The key or name of the Desktop State to get for this Serverless Service Stage. |

<a name="ServerlessSDK+desktop.removeStageState"></a>

#### desktop.removeStageState(orgUid, appUid, serviceName, stageName, stateKey) ⇒ <code>Promise.&lt;object&gt;</code>

Delete Desktop state for a Service Stage by specifying its key.

**Kind**: static method of [<code>desktop</code>](#ServerlessSDK+desktop)

| Param       | Type                | Description                                                                       |
| ----------- | ------------------- | --------------------------------------------------------------------------------- |
| orgUid      | <code>string</code> | The UID of the Serverless Organization to delete the Desktop State in.            |
| appUid      | <code>string</code> | The UID of the Serverless Application to delete the Desktop State in.             |
| serviceName | <code>string</code> | The name of the Serverless Service to delete the Desktop State in.                |
| stageName   | <code>string</code> | The name of the Serverless Service Stage to delete the Desktop State in.          |
| stateKey    | <code>string</code> | The key or name of the Desktop State to delete for this Serverless Service Stage. |
